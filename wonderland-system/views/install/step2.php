<?php
/**
 * Install Step 2 - Database Configuration
 */
        ...
        <div class="install-card">
            ...
            <div class="install-body">
                ...
                <p style="color: var(--gray-600); margin-bottom: 1.5rem;">
                    Masukkan informasi koneksi database MySQL Anda.
                </p>
                ...
                <form method="POST" action="<?= url('/install/step/2') ?>" id="dbForm">
                    <?= csrfField() ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" name="db_host" class="form-control" 
                                   value="<?= e($dbConfig['host']) ?>" placeholder="localhost">
                            <i class="fas fa-server input-icon"></i>
                        </div>
                        <p class="form-text">Biasanya "localhost" untuk shared hosting</p>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" name="db_name" class="form-control" 
                                   value="<?= e($dbConfig['name']) ?>" placeholder="u251802700_travel" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" name="db_user" class="form-control" 
                                   value="<?= e($dbConfig['user']) ?>" placeholder="u251802700_pimtravel" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="password" name="db_pass" class="form-control" 
                                   value="<?= e($dbConfig['pass']) ?>" placeholder="••••••••">
            ...
            <div class="install-footer">
                ...
                <div class="btn-group">
                    <a href="<?= url('/install/step/1') ?>" class="btn btn-secondary">
                        <i class="fas fa-arrow-left"></i>
                        Kembali
                    </a>
                    <button type="submit" form="dbForm" class="btn btn-primary" id="btnNext">
                        Lanjutkan
