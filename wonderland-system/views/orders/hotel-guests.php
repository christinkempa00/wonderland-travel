...
<div class="page-actions mb-4">
    ...
    <a href="<?= url('/orders/' . $order->id . '/hotel-attachment') ?>" target="_blank" class="btn btn-success">
...
<div class="row">
    <div class="col-12 col-lg-7">
        <form method="POST" action="<?= url('/orders/' . $order->id . '/hotel-guests') ?>" id="hotelGuestsForm">
            <?= csrfField() ?>
    ...
    <div class="col-12 col-lg-5">
        ...
        <div class="glass-card mb-4 preview-card">
            <div class="preview-header">
                ...
                <?php if (!empty($existingGuests)): ?>
                <a href="<?= url('/orders/' . $order->id . '/hotel-attachment') ?>" target="_blank" class="btn btn-sm btn-outline-primary">
        ...
        <div class="glass-card">
            ...
            <div class="quick-actions">
                <?php if (!empty($existingGuests)): ?>
                <a href="<?= url('/orders/' . $order->id . '/hotel-attachment') ?>" target="_blank" class="quick-action-btn">
...
function uploadHotelLogo(hotelItemId, input) {
    ...
    // Upload
    fetch(`/orders/${orderId}/upload-hotel-logo`, {
        method: 'POST',
        body: formData,
        headers: {
...
function deleteHotelLogo(hotelItemId) {
    ...
    fetch(`/orders/${orderId}/delete-hotel-logo`, {
        method: 'POST',
        headers: {
