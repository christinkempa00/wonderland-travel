...
<div class="page-actions mb-4">
    ...
    <a href="<?= url('/orders/' . $order->id . '/rental-attachment') ?>" target="_blank" class="btn btn-success">
...
<div class="row">
    <div class="col-12 col-lg-7">
        <form method="POST" action="<?= url('/orders/' . $order->id . '/rental-vehicles') ?>" id="rentalVehiclesForm">
            <?= csrfField() ?>
                ...
                <div class="rental-form-header">
                    <div class="rental-info">
                        ...
                        <div class="rental-meta">
                            ...
                            <span class="badge badge-secondary"><?= formatRupiahLocal($rental['unit_price']) ?>/unit</span>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-12 col-lg-5">
        ...
        <div class="glass-card mb-4 preview-card">
            <div class="preview-header">
                ...
                <?php if (!empty($existingDetails)): ?>
                <a href="<?= url('/orders/' . $order->id . '/rental-attachment') ?>" target="_blank" class="btn btn-sm btn-outline-danger">
        ...
        <div class="glass-card">
            ...
            <div class="quick-actions">
                <?php if (!empty($existingDetails)): ?>
                <a href="<?= url('/orders/' . $order->id . '/rental-attachment') ?>" target="_blank" class="quick-action-btn">
...
function uploadRentalLogo(rentalItemId, input) {
    ...
    fetch(`/orders/${orderId}/upload-rental-logo`, {
        method: 'POST',
        body: formData,
        headers: {
...
function deleteRentalLogo(rentalItemId) {
    ...
    fetch(`/orders/${orderId}/delete-rental-logo`, {
        method: 'POST',
        headers: {
