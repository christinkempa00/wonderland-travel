...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .wt-table .wt-item-sub { display: block; font-size: 16px; color: #777; margin-top: 2px; }
        .wt-table tbody tr:nth-child(even) { background: #fafafa; }
        .wt-participant-list { list-style: disc; margin: 4px 0 0 16px; padding: 0; font-size: 16px; color: #333; }
        .wt-participant-list li { margin-bottom: 1px; }

        .wt-subtotal-row {
            display: flex; justify-content: flex-end; gap: 20px;
            padding: 12px 4px 0; font-size: 16px; font-weight: 700;
        }
        .wt-subtotal-row .wt-subtotal-value { min-width: 130px; text-align: right; color: var(--wt-gold-dark); }

        .wt-terbilang { font-size: 16px; font-style: italic; color: #555; margin-top: 4px; text-align: right; }
